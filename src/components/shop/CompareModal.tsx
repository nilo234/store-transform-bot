    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl w-[95vw] max-h-[90vh] p-0 gap-0 overflow-hidden">
        ...
        <div className="flex items-center justify-between px-4 md:px-6 py-4 border-b border-border bg-muted/30">
          <h2 className="font-display text-lg md:text-xl font-bold">Compare Strips</h2>
            ...
            <div className={cn(
              ...
              {productData.map(p => (
                <div key={p.id} className="text-center relative group">
                  ...
                  <h3 className="font-display text-xs md:text-sm font-semibold leading-tight line-clamp-2 mb-1">
                    {p.title}
                  </h3>

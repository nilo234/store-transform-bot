...
const defaultFaqs: FAQ[] = [
  ...
  },
  {
    ...
    answer: "No hard feelings. We offer a 30-day money-back guarantee on your first order. Just email team@tryneuvie.com and we'll take care of it — no hoops, no hassle."
  },
  {

...
export const bundles: Bundle[] = [
  {
    ...
    products: ['Energy', 'Beauty + Collagen', 'Digestive + Gut Health'],
    variantIds: [shopifyVariants.energy, shopifyVariants.beautyCollagen, shopifyVariants.digestive],
    shopifyBundleVariantId: 'gid://shopify/ProductVariant/48723308413147',
    originalPrice: 99,
    salePrice: 79,
    savings: 20,
    discountPercent: 20,
    tagline: 'Start every day clear, glowing, and grounded.',
    subline: 'Energy, beauty, and gut health — your 30-second morning ritual.',
    discountCode: 'MORNING20',
    badge: 'BEST FOR STARTERS',
  },
  {
    id: 'beauty-from-within',
    name: 'BEAUTY FROM WITHIN BUNDLE',
    emoji: '✨',
    packSize: '3-Pack',
    category: 'beauty',
    products: ['Beauty + Collagen', 'Hair, Skin & Nails', 'Probiotic + Metabolism'],
    variantIds: [shopifyVariants.beautyCollagen, shopifyVariants.hairSkinNails, shopifyVariants.probiotic],
    shopifyBundleVariantId: 'gid://shopify/ProductVariant/48723308413147',
    originalPrice: 99,
    salePrice: 79,
    savings: 20,
    discountPercent: 20,
    tagline: 'Glow that starts on the inside.',
    subline: 'Collagen, biotin, and probiotics for skin, hair, and nails that show it.',
    discountCode: 'BEAUTY20',
    badge: 'MOST POPULAR',
  },
  {
    id: 'full-day-wellness',
    name: 'FULL DAY WELLNESS BUNDLE',
    emoji: '🌿',
    packSize: '4-Pack',
    category: 'wellness',
    products: ['Energy', 'Digestive + Gut Health', 'Sleep', 'Probiotic + Metabolism'],
    variantIds: [shopifyVariants.energy, shopifyVariants.digestive, shopifyVariants.sleep, shopifyVariants.probiotic],
    shopifyBundleVariantId: 'gid://shopify/ProductVariant/48723308413147',
    originalPrice: 129,
    salePrice: 99,
    savings: 30,
    discountPercent: 23,
    tagline: 'Morning to midnight wellness — covered.',
    subline: 'Energy, gut, sleep, and immunity in one full-day routine.',
    discountCode: 'FULLDAY23',
    badge: 'BEST VALUE',
  },
  {
    id: 'performance-power',
    name: 'PERFORMANCE POWER BUNDLE',
    emoji: '⚡',
    packSize: '4-Pack',
    category: 'performance',
    products: ['Energy', 'Mushroom Focus', 'Cognitive Relax', 'Iron'],
    variantIds: [shopifyVariants.energy, shopifyVariants.mushroomFocus, shopifyVariants.cognitiveRelax, shopifyVariants.iron],
    shopifyBundleVariantId: 'gid://shopify/ProductVariant/48723308413147',
    originalPrice: 129,
    salePrice: 99,
    savings: 30,
    discountPercent: 23,
    tagline: 'Sharp focus. Steady energy. Calm under pressure.',
    subline: 'For the days that demand everything.',
    discountCode: 'PERFORM23',
    badge: 'FOR ACHIEVERS',
  },
  {
    id: 'spring-reset',

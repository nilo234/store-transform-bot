...
export const blogPosts: BlogPost[] = [
  {
    slug: 'why-dissolving-strips-absorb-faster-than-capsules',
    title: 'Why Dissolving Strips Absorb Faster Than Capsules',
    excerpt: 'The science of sublingual absorption — and why a 30-second strip can outperform a pill that takes an hour to digest.',
    metaDescription: 'Why dissolving wellness strips absorb faster than capsules. Sublingual delivery, first-pass metabolism, and what it means for your daily routine.',
    category: 'Science',
    readTime: '4 min read',
    publishedAt: '2026-01-12',
    author: 'NEUVIE Team',
    content: [
      { paragraphs: ["Pills travel through your stomach, get broken down by acid, and lose a meaningful share of their active ingredients before reaching your bloodstream. Strips skip all of that.", "Sublingual absorption — through the tissue under your tongue — sends nutrients almost directly into circulation. Faster onset, less waste, no water needed."] },
    ],
    cta: { label: 'Shop All Strips', href: '/shop' },
  },
  {
    slug: 'the-30-second-morning-routine-that-actually-sticks',
    title: 'The 30-Second Morning Routine That Actually Sticks',
    excerpt: "Most wellness routines fail because they're too long. Here's the one that doesn't.",
    metaDescription: 'A simple 30-second morning routine built around dissolving wellness strips. No water, no mess, no excuses.',
    category: 'Routine',
    readTime: '3 min read',
    publishedAt: '2026-01-08',
    author: 'NEUVIE Team',
    content: [
      { paragraphs: ["The best routine is the one you actually do. Place a NEUVIE strip on your tongue, let it dissolve, and you're done — before the kettle even boils."] },
    ],
    cta: { label: 'Build Your Routine', href: '/quiz' },
  },
  {
    slug: 'collagen-vs-biotin-what-does-your-skin-actually-need',
    title: 'Collagen vs. Biotin: What Does Your Skin Actually Need?',
    excerpt: 'Two beauty staples, two different jobs. Here\u2019s how to choose — or stack them.',
    metaDescription: 'Collagen vs. biotin for skin, hair and nails. A clear, no-fluff comparison of how each works and when to use both.',
    category: 'Beauty',
    readTime: '5 min read',
    publishedAt: '2026-01-04',
    author: 'NEUVIE Team',
    content: [
      { paragraphs: ["Collagen supports skin elasticity and hydration. Biotin supports keratin — the protein in hair and nails. They work on different layers, which is why most people benefit from both."] },
    ],
    cta: { label: 'Shop Beauty Strips', href: '/product/beauty-collagen-strips' },
  },
  {
    slug: 'clean-energy-l-theanine-caffeine-works-better-together',
    title: 'Clean Energy: Why L-Theanine + Caffeine Works Better Together',
    excerpt: 'The pairing behind smooth, jitter-free focus — and why every Energy Strip uses both.',
    metaDescription: 'L-Theanine + caffeine: the science behind smooth, sustained energy without the crash. How NEUVIE Energy Strips use the pairing.',
    category: 'Energy',
    readTime: '4 min read',
    publishedAt: '2025-12-28',
    author: 'NEUVIE Team',
    content: [
      { paragraphs: ["Caffeine on its own can spike your heart rate and leave you crashing. L-Theanine smooths the curve — clean focus without the edge."] },
    ],
    cta: { label: 'Shop Energy Strips', href: '/product/energy-strips' },
  },
  {
    slug: 'how-to-build-a-supplement-routine-youll-actually-keep',
    title: "How to Build a Supplement Routine You'll Actually Keep",
    excerpt: 'Five rules for designing a wellness routine that survives real life.',
    metaDescription: "How to build a supplement routine that lasts. Practical rules for habit-stacking, format choice, and avoiding the drawer of forgotten bottles.",
    category: 'Wellness',
    readTime: '5 min read',
    publishedAt: '2025-12-20',
    author: 'NEUVIE Team',
    content: [
      { paragraphs: ["Anchor it to a habit you already have. Keep the format easy. Start with one product, not five. The rest takes care of itself."] },
    ],

...
export default function Returns() {
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <PageMeta
        title="Returns & 14-Day Guarantee – NEUVIE™ Wellness Strips"
        description="14-day money-back guarantee on all NEUVIE wellness strip orders. Easy returns, free return shipping, refund in 5–7 days."
      />
      <Navbar />
      ...
      <main className="flex-1">
        ...
        <section className="py-20 md:py-28" style={{ background: 'var(--gradient-hero)' }}>
          <div className="container-wide text-center">
            ...
            >
              We want you to feel completely confident in your choice of wellness strips. That's why every order is backed by our 14-day money-back guarantee.
            </motion.p>
          </div>
        </section>
          ...
          <div className="container-wide text-center">
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="flex flex-col items-center">
              ...
              <p className="text-accent-foreground/80 max-w-2xl text-lg">
                ...
                If it's not right for you, we'll make it right. Full refund within 14 days. No questions asked.
              </p>
            </motion.div>
          </div>
        </section>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
              ...
              <div className="mt-8 text-center space-y-4">
                ...
                <SocialShareButtons 
                  ...
                  text="NEUVIE offers a 14-day money-back guarantee on all wellness strip orders." 

...
const sections = [
  { title: 'Information We Collect', content: 'We collect information you provide directly to us when you use our website or purchase NEUVIE wellness strips:', list: ['Name and contact information when you create an account or place an order', 'Payment information to process transactions (securely processed by our payment providers)', 'Shipping address for order fulfillment', 'Communications when you contact our support team', 'Email address when you subscribe to our newsletter'] },
  { title: 'How We Use Your Information', content: 'We use the information we collect to:', list: ['Process and fulfill your wellness strip orders', 'Send order confirmations and shipping updates', 'Respond to your questions and provide customer support', 'Send promotional emails (with your consent)', 'Improve our website and services', 'Comply with legal obligations'] },
  ...
  { title: 'Contact Us About Privacy', content: 'If you have any questions about this Privacy Policy or how we handle your data, please contact us at privacy@neuvie.com', email: 'privacy@neuvie.com' },
];
...
export default function Privacy() {
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <PageMeta
        title="Privacy Policy – How NEUVIE™ Protects Your Data"
        description="How NEUVIE collects, uses, and protects your personal information when you shop our dissolving wellness strips. Updated January 2025."
      />
      <Navbar />
      ...
      <main className="flex-1">
        ...
        <section className="py-20 md:py-28" style={{ background: 'var(--gradient-hero)' }}>
          <div className="container-wide text-center">
            ...
            >
              Your privacy is important to us. This policy explains how we collect, use, and protect your information when you shop NEUVIE wellness strips.
            </motion.p>
            <motion.p
          ...
          <div className="container-wide max-w-3xl space-y-8">
            ...
            >
              <p className="text-muted-foreground">
                ...
                <Link to="/returns" className="text-primary hover:underline">Returns & Refund Policy</Link>. 
                Browse our{' '}
                <Link to="/shop" className="text-primary hover:underline">wellness strip collection</Link>.
              </p>
              <SocialShareButtons 
                url="https://tryneuvie.com/privacy" 
                text="NEUVIE's privacy policy – transparent about how they handle your data." 

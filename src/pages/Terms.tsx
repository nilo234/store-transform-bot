...
const termsSections = [
  { title: '1. Acceptance of Terms', content: 'By accessing or using the NEUVIE website and purchasing our products, you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our website or services.' },
  { title: '2. Products and Services', content: 'NEUVIE offers dietary supplement oral strips. Our products are not intended to diagnose, treat, cure, or prevent any disease. Please consult with a healthcare professional before starting any supplement regimen.\n\nWe reserve the right to modify, discontinue, or update our products at any time without prior notice.' },
  { title: '3. Ordering and Payment', content: 'When you place an order, you agree to provide accurate and complete information. We reserve the right to refuse or cancel any order for any reason, including but not limited to product availability, errors in pricing, or suspected fraudulent activity.\n\nPayment must be made at the time of purchase. We accept major credit cards and other payment methods as displayed at checkout.' },
  ...
  { title: '5. Returns and Refunds', content: 'We offer a 14-day money-back guarantee on all orders. Please see our Returns Policy for complete details on how to initiate a return and receive a refund.' },
  ...
  { title: '7. Limitation of Liability', content: 'NEUVIE shall not be liable for any indirect, incidental, special, or consequential damages arising from the use of our products or services. Our total liability shall not exceed the amount paid for the products in question.' },

        ...
        <section className="py-20">
          <div className="container-wide max-w-3xl">
            ...
            >
              ...
              <div className="bg-card rounded-xl p-8">
                <h2 className="font-display text-2xl font-bold mb-4">3. Ordering and Payment</h2>
                <p className="text-muted-foreground mb-4">
              ...
              <div className="bg-card rounded-xl p-8">
                <h2 className="font-display text-2xl font-bold mb-4">8. Privacy</h2>
                <p className="text-muted-foreground">
              ...
              <div className="bg-card rounded-xl p-8">
                <h2 className="font-display text-2xl font-bold mb-4">10. Contact Information</h2>
                <p className="text-muted-foreground">

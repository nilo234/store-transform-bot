  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <PageMeta
        ...
        description="Free US shipping on orders $50+. Ships within 1 business day. 3-5 day delivery. Tracking included. Learn about NEUVIE shipping rates and international options."
      />
      <Navbar />

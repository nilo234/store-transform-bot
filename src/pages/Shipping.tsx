...
const policySections = [
  ...
  { icon: Mail, title: "Questions? We're Here.", content: ['If you have any questions about your order or shipping, reach us at team@tryneuvie.com. Our team responds within 1 business day, Monday through Friday.'] },
];
...
export default function Shipping() {
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <PageMeta
        title="Shipping Policy – Fast Delivery for Wellness Strips | NEUVIE™"
        description="Free US shipping on orders $50+. Ships within 1 business day. Standard 3–5 days, Express 1–3 days. Track every order."
      />
      <Navbar />
      ...
      <main className="flex-1">
        ...
        <section className="py-20 md:py-28" style={{ background: 'var(--gradient-hero)' }}>
          <div className="container-wide text-center">
            ...
            >
              Shipping Policy for NEUVIE Wellness Strips
            </motion.h1>
            <motion.p
            ...
            >
              We want your wellness strips to reach you as quickly and smoothly as possible. 
              Here's everything you need to know about our shipping — no fine print, no surprises.
            </motion.p>
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 bg-secondary/30">
          <div className="container-wide max-w-2xl text-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }} className="space-y-4">
              <h2 className="font-display text-xl md:text-2xl text-foreground mb-6" style={{ letterSpacing: '-0.02em' }}>Shipping at a Glance</h2>
              ...
              <p className="text-sm text-muted-foreground pt-4">
                Need to return an order? See our{' '}
                <Link to="/returns" className="text-primary hover:underline">return and refund policy</Link>. 
                Ready to shop? Browse our{' '}
                <Link to="/shop" className="text-primary hover:underline">full collection of wellness strips</Link>. 
                Questions? <a href="mailto:team@tryneuvie.com" className="text-accent hover:underline">team@tryneuvie.com</a>
              </p>
              <SocialShareButtons 
                url="https://tryneuvie.com/shipping" 
                text="NEUVIE ships wellness strips fast — free shipping on $50+." 

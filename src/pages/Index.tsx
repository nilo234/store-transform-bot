          ...
          <div className="container-wide text-center max-w-2xl">
            <motion.div {...fadeUp}>
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                <Link to="/bundles">
                  <Button variant="outline" className="h-14 px-10 text-base font-semibold rounded-xl border-2 border-primary-foreground/40 bg-primary-foreground/10 text-primary-foreground hover:bg-primary-foreground/20">

...
// Gut Feeling = Probiotic + Digestive + Iron + Appetite Balance
const BUNDLE = bundles.find(b => b.id === 'gut-feeling')!;

// Display metadata aligned BY INDEX with BUNDLE.variantIds
// (Probiotic, Digestive, Iron, Appetite Balance — see src/data/bundles.ts)
const PRODUCT_META = [
  {
    name: 'Probiotic + Metabolism Strips',
    benefit: 'Daily gut balance, simplified.',
    outcomes: ['Supports a balanced gut', 'Helps everyday digestion', 'Easy to keep up with'],
  },
  {
    name: 'Digestive + Gut Health Strips',
    benefit: 'For the bloat-prone days.',
    outcomes: ['Eases that heavy feeling', 'Supports comfortable digestion', 'Travel and meal-friendly'],
  },
  {
    name: 'Iron Strips',
    benefit: 'Energy from the inside out.',
    outcomes: ['Supports daily iron intake', 'Gentle on your stomach', 'No metallic aftertaste'],
  },
  {
    name: 'Appetite Balance Strips',
    benefit: 'Steady cravings, calmer choices.',
    outcomes: ['Helps you tune in', 'Supports balanced routines', 'Slips into any day'],
  },
];

export default function GutFeelingLanding() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <PageMeta
        title="Gut Feeling Bundle – 4-Strip Daily Wellness | NEUVIE™"
        description="The premium 4-strip bundle for daily gut balance and inside-out wellness. Probiotic, Digestive, Iron, Appetite Balance. No pills. No water. Free US shipping $50+."
      />
      ...
      <main className="flex-1">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-14 items-center">
                        ...
                        <div key={i} className="bg-secondary/30 rounded-xl flex items-center justify-center p-2 overflow-hidden">
                          {bundleImages[i] ? (
                            <img
                              ...
                              alt={`${PRODUCT_META[i]?.name ?? 'NEUVIE strip'} — included in the Gut Feeling bundle`}
              ...
              >
                <div className="inline-flex items-center gap-2 bg-accent/15 text-accent px-3 py-1.5 rounded-full mb-4 text-xs font-semibold">
                  <Star className="h-3.5 w-3.5 fill-accent" /> 4.9/5 — Loved by women who want a simple daily routine
                </div>
                ...
                <ul className="grid grid-cols-1 sm:grid-cols-3 gap-2 mb-6 max-w-xl mx-auto lg:mx-0">
                  {['Daily balance', 'Less bloat', 'Steady energy'].map(b => (
        ...
        <section id="reviews" className="py-12 md:py-16 bg-secondary/40">
          <div className="container-wide max-w-6xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              {[
                { name: 'Lena R.', text: 'I used to forget my supplements every other day. These I actually take. The bundle is now part of my morning, no thinking required.' },
                { name: 'Priya N.', text: 'I bloat constantly when I travel. I brought this on a 10-day trip and felt so much better. The Digestive strip is my new must-pack.' },
                { name: 'Margot E.', text: 'I love that there is no aftertaste. The Iron one used to be the worst part of my routine. This one is genuinely pleasant.' },
                { name: 'Aisha K.', text: 'I bought this after a stressful season at work. My daily routine feels lighter. Even my partner asked what I started doing differently.' },
                { name: 'Olivia D.', text: 'The packaging fits in my purse. I take one after lunch and it does not feel like a supplement, it feels like a moment for myself.' },
                { name: 'Hannah L.', text: 'I have tried so many gut things. This is the first one I have actually finished the pack of. The format is the whole reason.' },
              ].map(r => (
          ...
          <div className="container-wide max-w-4xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                { step: '3', title: 'Go', text: 'Move on with your day. That is the whole routine.' },
              ].map(s => (
        ...
        <div id="faq">
          <ProductFAQs
            customFaqs={[
              {
                question: "What's included in the Gut Feeling Bundle?",
                answer: 'Four full-size NEUVIE dissolving strip products: Probiotic + Metabolism, Digestive + Gut Health, Iron, and Appetite Balance. Together they support a simple, premium daily wellness routine.',
              },
              {
              ...
              },
              {
                ...
                answer: 'Most customers take Probiotic and Iron in the morning, Digestive after meals, and Appetite Balance midday. Use them in the order that fits your day — there is no wrong way.',
              },
              {
              ...
              },
              {
                ...
                answer: 'Never. The strips dissolve on your tongue in seconds. No glass, no sink, no bag-fumbling.',
              },
              {
                question: 'Is this a good daily routine product?',
                answer: 'It was built for it. Gut Feeling was designed to slot into your morning, your desk, or your travel bag — quietly, simply, every day.',
              },
              {

      ...
      <main className="flex-1">
        ...
        <section className="max-w-[1200px] mx-auto py-8 md:py-12 px-4 md:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col">
            ...
            <div className="border border-green-800 bg-[#E8EFEA] p-4 mb-6 rounded text-sm relative">
              <div
                className="font-bold text-center mb-3 flex items-center justify-center gap-1.5"
        ...
        <section className="max-w-[1000px] mx-auto py-16 px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="rounded-xl overflow-hidden aspect-[4/3] bg-gray-100">
              ...
              {images[0] && (
                <img
                  src={optimizeShopifyImage(images[0]!, 600)}
                  className="w-full h-full object-cover"
                  alt="Benefits"
                />
              )}
        ...
        <section className="max-w-[1000px] mx-auto py-16 px-4">
          ...
          <div className="mt-8 text-center">
            ...
            <p className="text-[11px] font-bold mt-2 flex items-center justify-center gap-1.5">
              <ShieldCheck className="h-4 w-4" style={{ color: AURI_GREEN }} strokeWidth={1.75} /> 60-Day Moneyback
              Guarantee***
            </p>
          </div>
        </section>
